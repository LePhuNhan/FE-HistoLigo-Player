  ...
  const topics = [
    {
      ...
      description: "From medieval to modern",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhXcANQLW_r5EloGlu5cfvw9htSC9ebc2vPA&s",
      progress: 50,
    },
    {
      title: "Topic 2: Culture",
      description:
        "Language, cuisine, music, cinema, fashion, religion, and social values",
      image:
        "https://www.qeeq.com/blog/wp-content/uploads/2019/08/american-culture.jpg",
      progress: 70,
    },
    {
      title: "Topic 3: Weapon",
      description:
        "History of development and use of weapons and modern weapons",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqgUJgLBFoJ1PbNgL6n8qnpHG5ZGqvLc4ACg&s",
      progress: 30,
    },
  ];

  const references = [
    "Doc 1: The American Revolution: The Journey to Independence",
    "Doc 2: American Civil War: Causes and Consequences",
    "Doc 3: Reconstruction Period After the Civil War",
    "Doc 4: The Great Economic Depression of the 1930s",
    "Doc 5: The Civil Rights Movement and Social Change",
  ];
