    ...
    <div className="wrapHelp">
      ...
      <div className="breadCrumb">
        ...
        <div className="wrapRule">
          ...
          <p style={{ color: '#999' }}>Please note that these Terms and Conditions of Service were last revised on October 14th, 2024</p>
          <div className="itemRule">
            <span style={{ color: '#3c3c3c' }}>1.</span>
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>General</span>
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>Description of Website and Service</span>
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>Acceptable Use of the Services</span>
              You are responsible for your use of the Services, and for any use of the Services made using your account. Our goal is to create a positive, useful, and safe user experience. To promote this goal, we prohibit certain kinds of conduct that may be harmful to other users or to us. When you use the Services, you must comply with our Community Guidelines.            </p>
          </div>
          <div className="itemRule">
            <span style={{ color: '#3c3c3c' }}>4.</span>
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>Additional Terms
              </span>
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>Registration
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>Your Representations and Warranties
              </span>
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>Submission of Content
              </span>
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>Indemnification of Duolingo
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>License to Apps
              </span>
          ...
          <div className="itemRule">
            ...
            <p>
              <span style={{ color: '#3c3c3c', display: 'block', marginBottom: '3px', fontWeight: '600' }}>In-App Purchases
              </span>
